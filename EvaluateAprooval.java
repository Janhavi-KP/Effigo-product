...
public class EvaluateAprooval {
	...
	void basicInfo1()
	{
		driver.findElement(By.xpath("//input[@name='tenderTitle']")).sendKeys("effig");
...
//		js.executeScript("arguments[0].click()", cl);
	...
	void dates1()
	{
		driver.findElement(By.xpath("//input[@name=\"startBidSubmissionDate\"]")).sendKeys("11-04-2025 12:18:00");
		driver.findElement(By.xpath("//input[@name=\"endBidSubmissionDate\"]")).sendKeys("11-04-2025 12:19:00");
...
@Test(priority=9)
	...
	Thread.sleep(3000);
		...
		JavascriptExecutor js=(JavascriptExecutor)driver;
		WebElement ele1= driver.findElement(By.xpath("//tbody//tr//td[3][contains(text(),\"effig\")]"));
		
		js.executeScript("arguments[0].scrollIntoView(true);",ele1);
		WebElement ele= driver.findElement(By.xpath("//tbody//tr//td[3][contains(text(),\"effig\")]/..//td[5]//a"));
	...
	void New() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//tbody//tr//td[text()='effig']/../td[4]//a")).click();
...
//		}
	...
	void upeg() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("(//tbody//tr//td[text()='Janhavi KP']/../td[text()='Lead']/../td[@align=\"center\"])[1]")).click();
		driver.findElement(By.xpath("(//tbody//tr//td[text()='Janhavi KP']/../td[text()='Lead']/../td[@align=\"center\"])[2]")).click();
		driver.findElement(By.xpath("//input[@name=\"minCommercialEvaluators\"]")).sendKeys("1");
		driver.findElement(By.xpath("//button[@type=\"submit\"]")).click();
		//Thread.sleep(31000);

        WebElement elementToClick = driver.findElement(By.xpath("//a[@onclick=\"viewEval();\"]"));

        // Set the target time (e.g., 3:15 PM)
        LocalTime targetTime = LocalTime.of(12, 19); // 3:15 PM
